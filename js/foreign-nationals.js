const FOREIGN_NATIONALS = {
  ...
  body: "Official lists for tourists and foreign nationals after the Bhote Koshi flood. NDRRMA points to the Department of Tourism page and this situation update PDF (final update dated 30 August 2026, 19:00). We show the PDF here — names stay on the official document.",
  embedHint: "If the viewer is blank on your phone, open the PDF in a new tab. We do not copy names onto this page.",
  tourismUrl: "https://tourismdepartment.gov.np/content/185/tourist-list--out-of-contact--in-bhotekoshi/",
  pdfUrl: "/assets/ndrrma-foreign-nationals-30aug-2026.pdf",
  pdfSourceUrl: "https://ap.wps.com/l/cbCaigwQVrYF3ji7",
  pdfLabel: "Open PDF",
  pdfSourceLabel: "Official WPS link",
  pdfEmbedTitle: "Official situation update PDF — 30 August 2026, 19:00",
