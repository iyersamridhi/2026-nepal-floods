const I18N = {
  en: {
    ...
    homeCard3Desc: "Open the official SETU form, then WhatsApp / email contacts if needed.",
  ...
  np: {
    ...
    homeCard3Desc: "आधिकारिक SETU फारम खोल्नुहोस् — त्यसपछि व्हाट्सएप / इमेल सम्पर्क।",
