const I18N = {
  en: {
    ...
    dnaAlertTitle: "DNA samples to identify unidentified remains",
    dnaAlertBody:
      "Families of people missing after the Rasuwa / Bhote Koshi floods can help identification: give a DNA sample in Nepal (Police Hospital Maharajgunj or nearest District Police Office) or email a foreign lab profile to dnacodis@nepalpolice.gov.np.",
    dnaAlertCta: "Open Nepal Police notice →",
    dnaAlertSearchCta: "Check official lists →",
  ...
  np: {
    ...
    dnaAlertTitle: "अज्ञात शव पहिचानका लागि DNA नमूना",
    dnaAlertBody:
      "रसुवा / भोटेकोशी बाढीपछि हराएका व्यक्तिका परिवारले पहिचानमा सहयोग गर्न सक्नुहुन्छ: नेपालमा DNA नमूना (प्रहरी अस्पताल महाराजगञ्ज वा नजिकको जिल्ला प्रहरी कार्यालय) वा विदेशको ल्याब प्रोफाइल dnacodis@nepalpolice.gov.np मा पठाउनुहोस्।",
    dnaAlertCta: "नेपाल प्रहरी सूचना खोल्नुहोस् →",
    dnaAlertSearchCta: "आधिकारिक सूची जाँच →",
